...
module.exports = function (name) {
    ...
    const createBootstrap4Grid = fs.createWriteStream(`${name}/style/layouts/bootstrap-4-grid.css`);
    createBootstrap4Grid.write(vars.bootstrap4Grid);
    createBootstrap4Grid.end();

    const createBootstrap3Grid = fs.createWriteStream(`${name}/style/layouts/bootstrap-3-grid.css`);
