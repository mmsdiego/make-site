...
module.exports = function (name) {
    ...
    const createBootstrap4Grid = fs.createWriteStream(`${name}/style/layouts/_bootstrap-4-grid.scss`);
    createBootstrap4Grid.write(vars.bootstrap4Grid);
    createBootstrap4Grid.end();

    const createBootstrap3Grid = fs.createWriteStream(`${name}/style/layouts/_bootstrap-3-grid.scss`);
